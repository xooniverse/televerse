...
_UniqueGiftInfo _$UniqueGiftInfoFromJson(Map<String, dynamic> json) =>
    _UniqueGiftInfo(
      ...
      origin: $enumDecode(_$UniqueGiftOriginEnumMap, json['origin']),
...
Map<String, dynamic> _$UniqueGiftInfoToJson(_UniqueGiftInfo instance) =>
    <String, dynamic>{
      'gift': instance.gift,
      'origin': _$UniqueGiftOriginEnumMap[instance.origin]!,
...
const _$UniqueGiftOriginEnumMap = {
  UniqueGiftOrigin.upgrade: 'upgrade',
  UniqueGiftOrigin.transfer: 'transfer',
  UniqueGiftOrigin.resale: 'resale',
};
