...
/// @nodoc
mixin _$UniqueGiftBackdropColors {
  ...
  /// Create a copy of UniqueGiftBackdropColors
  ...
  @override
  String toString() {
    return 'UniqueGiftBackdropColors(centerColor: $centerColor, edgeColor: $edgeColor, symbolColor: $symbolColor, textColor: $textColor)';
  }
}
...
/// @nodoc
class _$UniqueGiftBackdropColorsCopyWithImpl<$Res>
    implements $UniqueGiftBackdropColorsCopyWith<$Res> {
  _$UniqueGiftBackdropColorsCopyWithImpl(this._self, this._then);

  final UniqueGiftBackdropColors _self;
  final $Res Function(UniqueGiftBackdropColors) _then;
...
/// @nodoc
class __$UniqueGiftBackdropColorsCopyWithImpl<$Res>
    implements _$UniqueGiftBackdropColorsCopyWith<$Res> {
  __$UniqueGiftBackdropColorsCopyWithImpl(this._self, this._then);

  final _UniqueGiftBackdropColors _self;
  final $Res Function(_UniqueGiftBackdropColors) _then;
