...
sealed class BackgroundFill with _$BackgroundFill {
  ...
  const factory BackgroundFill.solid({
    ...
    @Default(BackgroundFillType.solid) BackgroundFillType type,
  ...
  const factory BackgroundFill.gradient({
    ...
    @Default(BackgroundFillType.gradient) BackgroundFillType type,
  ...
  const factory BackgroundFill.freeformGradient({
    ...
    @Default(BackgroundFillType.freeformGradient) BackgroundFillType type,
