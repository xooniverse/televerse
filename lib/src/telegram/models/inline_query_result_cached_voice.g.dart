...
_$InlineQueryResultCachedVoiceImpl _$$InlineQueryResultCachedVoiceImplFromJson(
...
Map<String, dynamic> _$$InlineQueryResultCachedVoiceImplToJson(
        _$InlineQueryResultCachedVoiceImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
      'type': instance.type,
