...
_$InlineQueryResultMpeg4GifImpl _$$InlineQueryResultMpeg4GifImplFromJson(
...
Map<String, dynamic> _$$InlineQueryResultMpeg4GifImplToJson(
        _$InlineQueryResultMpeg4GifImpl instance) =>
    <String, dynamic>{
      'type': instance.type,
      'id': instance.id,
