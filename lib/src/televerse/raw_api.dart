...
class RawAPI {
  ...
  Future<bool> setWebhook({
    ...
    if (certificate != null) {
      ...
      files.add({
        'certificate': MultipartFile.fromStream(
  ...
  Future<bool> deleteWebhook({bool? dropPendingUpdates}) async {
    ...
    bool response = await HttpClient.postURI(uri, params);
    return response;
  }
  ...
  Future<WebhookInfo> getWebhookInfo() async {
    ...
    Map<String, dynamic> response = await HttpClient.postURI(uri, {});
  ...
  Future<bool> logOut() async {
    ...
    bool response = await HttpClient.postURI(uri, {});
    return response;
  }
  ...
  Future<Message> sendAnimation(
    ...
    if (animation.type == InputFileType.file ||
      ...
      if (animation.type == InputFileType.file) {
        ...
        files.add({
          'animation': MultipartFile.fromBytes(
  ...
  Future<Message> sendVideoNote(
    ...
    if (videoNote.type == InputFileType.file ||
      ...
      if (videoNote.type == InputFileType.file) {
        ...
        files.add({
          'video_note': MultipartFile.fromBytes(
  ...
  Future<List<ChatMember>> getChatAdministrators(
    ...
    List<dynamic> data = await HttpClient.postURI(
  ...
  Future<int> getChatMembersCount(
    ...
    int response = await HttpClient.postURI(
  ...
  Future<bool> setStickerSetThumbnail(
    ...
    if (thumbnail != null) {
      if (thumbnail.type == InputFileType.file) {
        files.add({
          thumbnail.file!.filename: MultipartFile.fromBytes(
            thumbnail.file!.readAsBytesSync(),
